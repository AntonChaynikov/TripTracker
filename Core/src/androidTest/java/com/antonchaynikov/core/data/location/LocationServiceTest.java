...
public class LocationServiceTest {
    ...
    public void shouldCallToStopUpdates_whenOnDestroy() throws Exception {
        ...
        Mockito.verify(mockLocationProvider).stopUpdates(ArgumentMatchers.any(LocationConsumer.class));
    }
    ...
    public void shouldEmitLocation_whenOneReceived() throws Exception {
        ...
        Mockito.doNothing().when(mockLocationProvider).startUpdates(argumentCaptor.capture());
