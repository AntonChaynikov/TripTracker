...
public class StatisticsCalculatorTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.doReturn(10f).when(loc1).distanceTo(ArgumentMatchers.any(Location.class));
        Mockito.doReturn(20f).when(loc2).distanceTo(ArgumentMatchers.any(Location.class));

        Mockito.doReturn(0L).when(loc1).getTime();
        Mockito.doReturn(1000L).when(loc2).getTime();
        Mockito.doReturn(4000L).when(loc3).getTime();
