...
public class StatisticsFormatterTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.doReturn(mockContext).when(mockContext).getApplicationContext();
        Mockito.doReturn("Eternity").when(mockContext).getString(R.string.statistics_duration_eternity);
        Mockito.doReturn("0s").when(mockContext).getString(R.string.statistics_duration_zero);
        Mockito.doReturn("%s km").when(mockContext).getString(R.string.statistics_distance_km);
        Mockito.doReturn("%s m").when(mockContext).getString(R.string.statistics_distance_m);
        Mockito.doReturn("%s km/h").when(mockContext).getString(R.string.statistics_speed_kmh);
        Mockito.doReturn("%s m/s").when(mockContext).getString(R.string.statistics_speed_mps);
